    ...
    useEffect(() => {
      const x = async () => {
        ...
        if (storedData) {
          ...
          setCurrentUserImage(data?.avatarImage || "defaultAvatar.png"); // Use a default image if avatarImage is missing
        } else {
          console.error("No user data found in localStorage");
          // Optionally navigate to login or handle the case where data is null
        }
      };
      x();
    }, []);
        ...
        currentUserImage&&currentUserName&&(
          ...
          <div className={`contact ${
            ...
            <div className="username">
                <h2>{contact.username!=null?contact.username:""}</h2>
            </div>
          </div>
                );
             })} 
