...
//     // const api=`api.dicebear.com/7.x/lorelei/svg`;
...
useEffect(() => {
  ...
  for (let i = 0; i < 4; i++) {
    const image = await axios.get(
      `https://api.dicebear.com/9.x/bottts/svg?seed=${Math.floor(Math.random()*1000)}`,
      { responseType: "text" } // important!
    );
   console.log(image);
    const base64 = window.btoa(
      unescape(encodeURIComponent(image.data))
    );
